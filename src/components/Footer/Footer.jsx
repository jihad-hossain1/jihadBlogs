    ...
    <div className="bg-slate-100">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-[1200px] mx-auto p-2 gap-3 mt-6 p-3">
        <div className="text-gray-800">
          <h2 className="py-2 pl-3 pb-4 text-2xl">Last Responses</h2>
        ...
        <div className="text-gray-800">
          <h2 className="mb-6 text-2xl">Last Tweet</h2>
        ...
        <div className="text-gray-800">
          <div>
            ...
            <p className="break-all mb-3 text-gray-500">
              D -Blog is a responsive, beautiful, creative & unique wordpress
              theme best suited for blogs & personal portfolio showcases. It’s
              easy to use & setup, SEO friendly and has top notch standard
              compliant code.
            </p>
          </div>
          <div className="text-gray-800 ">
            <h2 className="text-gray-600 mb-5 text-2xl">Newsletters</h2>
            <p className="mb-3">
