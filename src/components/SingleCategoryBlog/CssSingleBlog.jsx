...
const CssSingleBlog = ({ art }) => {
  ...
  return (
    <div className="border-l-[14px] border-[#38b7ea] p-4 md:p-8 bg-white shadow-sm">
      <div>
        <div className="flex justify-between items-center mb-2 md:mb-4">
          <h4 className="text-xs text-blue-gray-600">
            {articlePublishDate || `empty`}
          </h4>
          <p className="text-sm text-[#38b7ea]">
