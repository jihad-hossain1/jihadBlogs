...
const SingleArticle = ({ article }) => {
  ...
  // return (
  //   <div
  //     className="bg-no-repeat h-[300px] bg-[#100f0f34]  transition duration-300 ease-in-out hover:opacity-80 rounded-md border-3 border-gray-500 p-3"
  //     style={{ backgroundImage: `url(${article.image})` }}
  //   >
  //     <h4 className="text-gray-900 font-semibold text-2xl">
  //       {article?.articleTitle}
  //     </h4>
  //   </div>
  // );
